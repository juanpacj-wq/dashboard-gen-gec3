...
# D-126: ya no se instala Chromium. Playwright existía SOLO para el fallback PME (retirado);
# los scrapers de XM bajan los archivos por HTTP (undici/cheerio), sin navegador. El caché
# viejo en $APP_DIR/.ms-playwright quedó huérfano y se puede borrar a mano para liberar disco.
